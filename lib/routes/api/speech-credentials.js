...
const encryptCredential = (obj) => {
  ...
  switch (vendor) {
    ...
    case 'aws':
      assert(access_key_id || role_arn, 'invalid aws speech credential: access_key_id or role_arn is required');
      assert(secret_access_key || role_arn, 'invalid aws speech credential: secret_access_key or role_arn is required');
