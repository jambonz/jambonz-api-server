...
const encryptCredential = (obj) => {
  const {
    ...
    use_custom_tts,
    custom_tts_endpoint,
    custom_tts_endpoint_id,
    use_custom_stt,
    custom_stt_endpoint,
    custom_stt_endpoint_id,
    tts_api_key,
    tts_region,
    stt_api_key,
    stt_region,
  ...
  switch (vendor) {
    ...
    case 'microsoft':
      if (!custom_tts_endpoint && !custom_stt_endpoint) {
  ...
  try {
    ...
    res.status(200).json(creds.map((c) => {
      ...
      if ('google' === obj.vendor) {
        ...
        obj.custom_tts_endpoint_id = o.custom_tts_endpoint_id;
        obj.use_custom_stt = o.use_custom_stt;
        obj.custom_stt_endpoint = o.custom_stt_endpoint;
        obj.custom_stt_endpoint_id = o.custom_stt_endpoint_id;
