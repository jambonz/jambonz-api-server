...
const isAdminOrAccountScope = (req, res, next) => {
...
api.use('/VoipCarriers', isAdminOrAccountScope, require('./voip-carriers'));
api.use('/Webhooks', isAdminOrAccountScope, require('./webhooks'));
api.use('/SipGateways', require('./sip-gateways'));
api.use('/PhoneNumbers', isAdminOrAccountScope, require('./phone-numbers'));
