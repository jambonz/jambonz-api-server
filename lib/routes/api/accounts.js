...
function validateUpdateCall(opts) {
  ...
  if ('tag' == opts.conferenceParticipantState?.action && !opts.tag) {
    throw new DbErrorBadRequest('conferenceParticipantState requires tag property when action is \'tag\'');
  }
  if ('coach' == opts.conferenceParticipantState?.action && !opts.tag) {
    throw new DbErrorBadRequest('conferenceParticipantState requires tag property when action is \'coach\'');
  }
}
