...
router.post('/:sid/SubspaceTeleport', async(req, res) => {
  ...
  try {
    ...
    await Account.update(req.params.sid, updatedObj);
...
router.delete('/:sid', async(req, res) => {
  ...
  try {
    ...
    // should prob delete the subspace sip teleport
    if (subspace_client_id && subspace_client_secret && subspace_sip_teleport_id) {
      await disableSubspace({subspace_client_id, subspace_client_secret, subspace_sip_teleport_id});
    }
