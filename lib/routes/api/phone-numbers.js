...
async function validateAdd(req) {
  ...
  if (req.body.voip_carrier_sid) {
    ...
    if (req.user.hasAccountAuth && carrier.account_sid !== req.user.account_sid) {
      throw new DbErrorForbidden('insufficient privileges');
    }
    if (req.user.hasServiceProviderAuth && carrier.service_provider_sid !== req.user.service_provider_sid) {
      throw new DbErrorForbidden('insufficient privileges');
    }
  }
}
