...
class Account extends Model {
  ...
  static async bucketTestResult(sid, success) {
    await promisePool.execute(
      'UPDATE accounts SET bucket_last_tested = NOW(), bucket_tested_ok = ? WHERE account_sid = ?',
      [success, sid]);
  }
...
Account.fields = [
  ...
  {
    name: 'bucket_tested_ok',
    type: 'number'
  },
  {
    name: 'bucket_last_tested',
    type: 'date'
  },
];
